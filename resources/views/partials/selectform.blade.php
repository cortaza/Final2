...
<select class="form-select" id="validationCustom04" required="" name="forma" onchange="location = this.value;">    
    <option  for="validationCustom04"selected="" disabled="" placeholder="">Elegir...</font></font></option>
    <option  for="validationCustom04"value="{{route('redindex')}}">Red</option>
    <option  for="validationCustom04"value="{{route('areaindex')}}">Area</option>
    <option  for="validationCustom04"value="{{route('instructorindex')}}">Instructores</option>
    ...
    <option  for="validationCustom04"value="{{route('fichaindex')}}">Fichas</option>
    <option for="validationCustom04" value="{{route('ambienteindex')}}">Ambiente de formacion</option>
    <option  for="validationCustom04"value="{{route('competenciaindex')}}">Competencias</option>
    <option for="validationCustom04" value="{{route('resultadoindex')}}">Resultados</option>
    <option for="validationCustom04" value="{{route('semaforoindex')}}">Semaforos</option>
